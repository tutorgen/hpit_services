...
class GraphingAQuadraticByFindingTheVertexAndTheXInterceptsProblem:
    ...
    short_description = "Graphing a quadratic by finding the vertex and the x-intercepts."
    problem_enabled = False
...
class DistributingWithPolynomialsWordProblemProblem:
    skill_name = "distributing_with_polynomials_word_problem"
    short_description = "Distributing with polynomials word problem."
    problem_enabled = False
...
class GraphingAQuadraticByUsingAnXYTableProblem:
