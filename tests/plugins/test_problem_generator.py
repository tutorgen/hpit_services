...
class TestProblemGeneratorPlugin(unittest.TestCase):
    ...
    def test_list_problems_callback(self):
        """
        ProblemGeneratorPlugin.list_problems_callback() Test plan:
            - send with no subject
            - send with invalid subject
            - send with no category
            - send with invalid category
            - send with no skill
            - send with invalid skill
            - send with subject, category, skill
        """
